...
const styles = StyleSheet.create({
  ...
  header: { height: 56, paddingHorizontal: 30, flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  headerTitle: { color: colors.ink, fontSize: 18, lineHeight: 22, fontWeight: "600" },
  receiptScroll: { flex: 1 },
  receiptBody: { flexGrow: 1, paddingHorizontal: 24, paddingTop: 0, paddingBottom: 20 },
  successCircle: { alignSelf: "center", width: 64, height: 64, borderRadius: 32, alignItems: "center", justifyContent: "center", backgroundColor: colors.green, marginBottom: 26 },
  amount: { color: colors.ink, fontSize: 24, lineHeight: 29, fontWeight: "700", textAlign: "center" },
  personName: { color: colors.muted, fontSize: 15, lineHeight: 20, fontWeight: "400", textAlign: "center", marginTop: 12 },
  categoryPill: { alignSelf: "center", minWidth: 138, height: 38, marginTop: 20, paddingLeft: 16, paddingRight: 6, borderRadius: 20, flexDirection: "row", alignItems: "center", justifyContent: "space-between", backgroundColor: "#F4F4F6" },
  categoryText: { color: "#242426", fontSize: 14, fontWeight: "400" },
  section: { marginTop: 30 },
  sectionTitle: { color: colors.ink, fontSize: 18, lineHeight: 23, fontWeight: "700", marginBottom: 20 },
  infoRow: { flexDirection: "row", alignItems: "flex-start", justifyContent: "space-between", gap: 16, marginBottom: 22 },
  rowPressed: { opacity: 0.62 },
  infoLabel: { color: colors.muted, fontSize: 14, lineHeight: 19, flexShrink: 0 },
  ...
  descriptionLink: { color: colors.orange, fontSize: 14, lineHeight: 19, fontWeight: "600", marginTop: 24 },
  separator: { height: 14, marginTop: 30, marginHorizontal: -30, backgroundColor: "#252527" },
  recipientSection: { marginTop: 30 },
