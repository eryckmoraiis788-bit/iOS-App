...
const styles = StyleSheet.create({
  ...
  amount: { color: colors.ink, fontSize: 27, lineHeight: 32, fontWeight: "700", textAlign: "center" },
  personName: { color: colors.muted, fontSize: 17, lineHeight: 22, fontWeight: "400", textAlign: "center", marginTop: 12 },
  ...
  categoryText: { color: "#242426", fontSize: 16, fontWeight: "400" },
  section: { marginTop: 78 },
  sectionTitle: { color: colors.ink, fontSize: 20, lineHeight: 25, fontWeight: "700", marginBottom: 34 },
  ...
  idValue: { color: colors.ink, fontSize: 16, lineHeight: 21, fontWeight: "600", marginTop: 10, paddingRight: 42 },
  copyIcon: { position: "absolute", right: 0, bottom: 0 },
  descriptionLink: { color: colors.orange, fontSize: 16, lineHeight: 21, fontWeight: "600", marginTop: 32 },
