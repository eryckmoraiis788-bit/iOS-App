...
const styles = StyleSheet.create({
  ...
  categoryPill: { alignSelf: "center", minWidth: 138, height: 38, marginTop: 32, paddingLeft: 16, paddingRight: 6, borderRadius: 20, flexDirection: "row", alignItems: "center", justifyContent: "space-between", backgroundColor: "#F4F4F6" },
  categoryText: { color: "#242426", fontSize: 14, fontWeight: "400" },
  section: { marginTop: 48 },
  sectionTitle: { color: colors.ink, fontSize: 18, lineHeight: 23, fontWeight: "700", marginBottom: 30 },
  ...
  descriptionLink: { color: colors.orange, fontSize: 14, lineHeight: 19, fontWeight: "600", marginTop: 32 },
