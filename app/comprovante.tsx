...
const styles = StyleSheet.create({
  ...
  successCircle: { alignSelf: "center", width: 64, height: 64, borderRadius: 32, alignItems: "center", justifyContent: "center", backgroundColor: colors.green, marginBottom: 48 },
  ...
  categoryPill: { alignSelf: "center", minWidth: 138, height: 38, marginTop: 45, paddingLeft: 16, paddingRight: 6, borderRadius: 20, flexDirection: "row", alignItems: "center", justifyContent: "space-between", backgroundColor: "#F4F4F6" },
