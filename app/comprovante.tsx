...
const styles = StyleSheet.create({
  ...
  headerTitle: { color: colors.ink, fontSize: 16, lineHeight: 20, fontWeight: "700", textAlign: "center", flex: 1 },
  ...
  amount: { color: colors.ink, fontSize: 28, lineHeight: 34, fontWeight: "700", textAlign: "center" },
  personName: { color: colors.muted, fontSize: 15, lineHeight: 20, textAlign: "center", marginTop: 6, paddingHorizontal: 20 },
  ...
  categoryText: { color: "#242428", fontSize: 14 },
  transactionSection: { marginTop: 56, paddingHorizontal: 45 },
  sectionTitle: { color: colors.ink, fontSize: 19, lineHeight: 24, fontWeight: "700", marginBottom: 23 },
  ...
  infoValue: { color: colors.ink, fontSize: 14, lineHeight: 19, fontWeight: "700", textAlign: "right", flex: 1, minWidth: 0 },
  idBlock: { marginTop: 2 },
  idRow: { flexDirection: "row", alignItems: "center", gap: 10, marginTop: 8 },
  idValue: { color: colors.ink, fontSize: 14, lineHeight: 19, fontWeight: "700", flex: 1 },
  descriptionLink: { marginTop: 24 },
  descriptionText: { color: colors.orange, fontSize: 14, fontWeight: "700" },
