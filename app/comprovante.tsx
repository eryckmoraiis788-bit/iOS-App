...
const styles = StyleSheet.create({
  ...
  headerTitle: { color: colors.ink, fontSize: 22, lineHeight: 27, fontWeight: "700", textAlign: "center", flex: 1 },
  receiptScroll: { flex: 1 },
  receiptBody: { paddingBottom: 35 },
  directionCircle: { alignSelf: "center", width: 116, height: 116, borderRadius: 58, marginTop: 50, alignItems: "center", justifyContent: "center", backgroundColor: "#29292B" },
  amountPressable: { alignSelf: "center", borderRadius: 8, paddingHorizontal: 8, marginTop: 50 },
  amount: { color: colors.ink, fontSize: 42, lineHeight: 50, fontWeight: "700", textAlign: "center" },
  personName: { color: colors.muted, fontSize: 24, lineHeight: 30, textAlign: "center", marginTop: 12, paddingHorizontal: 20 },
  categoryPill: { alignSelf: "center", minWidth: 246, height: 60, borderRadius: 30, marginTop: 62, paddingLeft: 28, paddingRight: 8, flexDirection: "row", alignItems: "center", justifyContent: "space-between", backgroundColor: "#F4F4F6" },
  categoryText: { color: "#242428", fontSize: 20 },
  transactionSection: { marginTop: 92, paddingHorizontal: 45 },
  sectionTitle: { color: colors.ink, fontSize: 28, lineHeight: 34, fontWeight: "700", marginBottom: 42 },
  infoRow: { flexDirection: "row", alignItems: "flex-start", justifyContent: "space-between", gap: 18, marginBottom: 36 },
  infoLabel: { color: colors.muted, fontSize: 20, lineHeight: 26, flexShrink: 0 },
  infoValue: { color: colors.ink, fontSize: 20, lineHeight: 26, fontWeight: "700", textAlign: "right", flex: 1, minWidth: 0 },
  idBlock: { marginTop: 2 },
  idRow: { flexDirection: "row", alignItems: "center", gap: 12, marginTop: 10 },
  idValue: { color: colors.ink, fontSize: 20, lineHeight: 26, fontWeight: "700", flex: 1 },
  descriptionLink: { marginTop: 40 },
  descriptionText: { color: colors.orange, fontSize: 20, fontWeight: "700" },
  divider: { height: 78, marginTop: 75, backgroundColor: colors.panel },
  participantSection: { paddingHorizontal: 45, paddingTop: 70, paddingBottom: 48 },
  participantRow: { position: "relative", width: "100%", minHeight: 26, flexDirection: "row", alignItems: "center" },
  participantRowSpaced: { marginBottom: 36 },
