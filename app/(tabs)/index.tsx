...
const styles = StyleSheet.create({
  ...
  buttonShell: { backgroundColor: "#F4FAFA", borderRadius: 22, padding: 14, borderWidth: 1, borderColor: colors.border, overflow: "visible" },
  primaryButton: { width: "100%", height: 54, minHeight: 54, borderRadius: 15, borderWidth: 1, borderColor: "transparent", alignItems: "center", justifyContent: "center", paddingHorizontal: 12, paddingVertical: 0, position: "relative", overflow: "visible" },
  primaryButtonReady: { backgroundColor: colors.teal, borderColor: colors.teal, opacity: 1, shadowColor: colors.teal, shadowOpacity: 0.28, shadowRadius: 8, shadowOffset: { width: 0, height: 3 }, elevation: 4 },
  primaryButtonDisabled: { backgroundColor: colors.teal, borderColor: colors.teal, opacity: 1, shadowColor: colors.teal, shadowOpacity: 0.18, shadowRadius: 6, shadowOffset: { width: 0, height: 2 }, elevation: 3 },
  primaryIconSlot: { position: "absolute", left: 12, width: 32, height: 54, alignItems: "center", justifyContent: "center" },
  primaryText: { position: "absolute", left: 0, right: 0, color: colors.white, fontSize: 15, lineHeight: 20, fontWeight: "900", textAlign: "center" },
