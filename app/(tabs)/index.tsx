...
const styles = StyleSheet.create({
  ...
  primaryButton: { width: "100%", height: 54, borderRadius: 15, borderWidth: 1.5, borderColor: "transparent", alignItems: "center", justifyContent: "center", position: "relative" },
  ...
  primaryIconSlot: { position: "absolute", left: 12, width: 32, alignItems: "center", justifyContent: "center" },
