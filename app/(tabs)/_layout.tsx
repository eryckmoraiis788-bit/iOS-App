...
export default function TabLayout() {
  ...
  return (
    <Tabs screenOptions={{
      ...
      <Tabs.Screen name="receipts" options={{ title: "Comprovantes", tabBarLabelStyle: { fontSize: 10, fontWeight: "700" }, tabBarIcon: ({ color }) => <IconSymbol name="receipt" size={25} color={color} /> }} />
